...
const routes: Routes = [
  ...
  { path: 'products', canActivate: [AuthGuardService], loadComponent: () => import('./components/displayproducts/displayproducts.component').then(c => c.DisplayproductsComponent) },
  {
